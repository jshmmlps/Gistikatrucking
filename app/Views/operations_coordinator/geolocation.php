...
<div class="container-fluid mt-4">
    ...
    <ul class="nav nav-tabs" id="managementTabs" role="tablist">
        <a href="<?= base_url('operations/trucks'); ?>" 
           class="nav-link <?= (current_url() == base_url('operations/trucks')) ? 'active' : '' ?>">
            Truck Records
        </a>
        <a href="<?= base_url('operations/geolocation'); ?>" 
           class="nav-link <?= (current_url() == base_url('operations/geolocation')) ? 'active' : '' ?>">
            Geolocation
        </a>
    </ul>
