            ...
            <tbody>
                <?php foreach ($trucks as $row): ?>
                    <tr>
                        ...
                        <td><?= esc($row['type']) ?></td>
                        <td><button type="button" class="btn btn-secondary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><a href="#" class="view-truck" onclick="view(<?= htmlspecialchars(json_encode($row), ENT_QUOTES, 'UTF-8') ?>)">View</a></button>
