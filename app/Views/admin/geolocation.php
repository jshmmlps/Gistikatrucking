...
<div class="container-fluid mt-4">
    ...
    <ul class="nav nav-tabs" id="managementTabs" role="tablist">
        <a href="<?= base_url('admin/trucks'); ?>" 
           class="nav-link <?= (current_url() == base_url('admin/trucks')) ? 'active' : '' ?>">
            Truck Records
        </a>
        <a href="<?= base_url('admin/geolocation'); ?>" 
           class="nav-link <?= (current_url() == base_url('admin/geolocation')) ? 'active' : '' ?>">
            Geolocation
        </a>
        <a href="<?= base_url('admin/maintenance'); ?>" 
           class="nav-link <?= (current_url() == base_url('admin/maintenance')) ? 'active' : '' ?>">
